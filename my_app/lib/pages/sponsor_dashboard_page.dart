...
class _SponsorDashboardPageState extends State<SponsorDashboardPage> {
  ...
  Future<void> _fetchLocations() async {
    try {
      ...
      final fetchedLocations = data.map<String>((row) => row['location'].toString()).toSet().toList();
  ...
  Widget _buildBody() {
    switch (_selectedIndex) {
      ...
      case 2:
        return BidsPage(sponsorId: widget.sponsorId); // Correctly load the Bids page
      case 3:
                        ...
                        return Card(
                          ...
                          child: ListTile(
                            ...
                            trailing: IconButton(
                              ...
                              onPressed: billboard['availability']
                                  ? () {
                                      Navigator.push(
                                        context,
                                        MaterialPageRoute(
